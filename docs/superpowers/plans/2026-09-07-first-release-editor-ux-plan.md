...
2026-09-08 补充：#93/#94 已合入 main `df00a14`；后续执行按
[最新 main 增量计划](2026-09-08-v0.10-release-readiness-plan.md)及其实现设计分包。
下文保留原 R1–R8 产品目标与历史实现说明，不再据“本分支”措辞判断最新合并状态。
B 包 Duplicate/资源交互/命名导出已在当前工作区实现并本机验证，见
[2026-09-08 B 包记录](../../verification/2026-09-08-editor-duplicate-assets.md)；尚未提交/合并。
